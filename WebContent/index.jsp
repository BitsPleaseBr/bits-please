...
<body>
	...
	<nav class="navbar sticky-top navbar-expand navbar-light"
		...
		<a class="navbar-brand" href="index.jsp"> <img src="_img/icon.png"
			width="30" height="30" class="d-inline-block align-top" alt="Home">
			Home
		</a>
		...
		<form class="form-inline">
			<button class="btn btn-danger" type="button" data-toggle="modal"
				data-target="#modal_login">Acesso</button>
		</form>
	</nav>
		...
		<div class="modal-dialog" id="dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>
						<small class="form-text text-muted">Vamos lá! Preencha o
							cadastro para começar a utilizar a HealthCore!</small>
					</p>
					<form style="text-align: center" id="escolha">
						<p class="lead">Primeiro, se identifique:</p>
						<button type="button" class="btn btn-info" name="groups"
							id="paciente">Paciente</button>
