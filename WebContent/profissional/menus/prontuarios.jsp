    ...
    <div class="row">
          <div class="col-md-4">
            ...
            <div class="row">
			  ...
			  <div class="col-sm-3 pront" style="display: none">
                <div class="pull-right">
                  <button class="btn btn-success btn-round btn-icon btn-sm" id="newpront">
        ...
        <script>
        $('#newpront').click(function(){
        	window.location.href = 'criarProntuario.jsp' 
        })
