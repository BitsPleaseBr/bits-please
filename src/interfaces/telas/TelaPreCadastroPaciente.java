...
public class TelaPreCadastroPaciente extends MainPanel {
  ...
  protected void addComponents() {
    ...
    setFonte(new JComponent[] { lblNome, txtNome, lblSobrenome, txtSobrenome, lblDataNasc,
        txtDataNasc, lblCPF, txtCPF, lblTelefone, txtTelefone, lblEmail, txtEmail, lblSenha,
        txtSenha, btnProximo }, fonteTituloTxt);
  ...
  protected void addListeners() {
    ...
    // Adicionando listener para quando o botao Próximo for clickado verificar
    // se os
