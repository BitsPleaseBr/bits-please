...
public enum EnderecoInfo implements Info {
  ...
  Cep("cep", a -> Parsers.cepParse(a)), Estado("estado"), Cidade("cidade"), Bairro("bairro"), Rua(
      "rua"), Numero("numero", a -> Parsers.removeNonNum(a)), Complemento(
          "complemento"), IdUser("user_id"), Tipo("tipo");
  ...
  EnderecoInfo(String campo, Function<Object, Object> parser) {
    this.campo = campo;
    this.parser = parser;
  }
