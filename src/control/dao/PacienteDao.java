...
public class PacienteDao {
	...
	public void pre_cadastrar(PacienteBean paciente) {
		...
		String sql = "INSERT INTO usuarios(nomeUser, sobrenomeUser, nascimentoUser, cpfUser, telefoneUser, emailUser, pswdUSer) VALUES(?, ?, ?, ?, ?, ?, ?)";
		...
		try{
			...
			// Converte a string de hash de senha em um binário para ser armazenado no bando de dados
