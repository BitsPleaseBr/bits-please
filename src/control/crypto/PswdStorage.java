...
public class PswdStorage {
  ...
  public static String clientPswdHash(String password, String email) {
    final String prefixo = "$2a$10$"; // String prefixado no salt com parâmetros de hashing para o algoritmo
    String salt = email + "bitspleasebrsaltcombr"; // O salt recebe um sufixo para garantir que o salt tenha um tamanho mínimo necessário ]
